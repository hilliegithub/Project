    ...
    if ($_POST) {
        if (!empty($_POST['username']) && !empty($_POST['email']) && !empty($_POST['password']) && !empty($_POST['confirmpassword'])) {
            ...
            $all_bind_values = [
                ...
                'salt' => $salt,
                'isadmin' => ($_POST['isAdmin'] === 'on') ? true : false
            ];
...
<body class="hmm">
    <main>
        ...
        <div class="alert alert-danger" role="alert">
            <?= $errorMessage ?>. <a href="manageUsers.php" class="alert-link">Click Here To Back To Manage Users</a>
        </div>
        <?php endif ?>
        ...
        <div class="container mt-2 bg-white">
            ...
            <form id="registerform" action="adminCreateUser.php" method="post" class="pb-2">
                <div class="form-row">
                ...
                <div class="form-row">
                    <div class="form-group col-12 col-md-6">
                        <label for="isAdmin">Do you wish to make adminstrator?</label>
                        <input type="checkbox" class="form-control" id="isAdmin" name="isAdmin">
                    </div>
                </div>
                <button id="submit" class="btn btn-primary" name="submit" type="submit">Create User</button>
            </form>
        </div>
    </main>
